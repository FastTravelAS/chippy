...
RSpec.describe Chippy::Message::Body do
  describe ".parse" do
    it "returns a new body object with the data from the hex string" do
      body = Chippy::Message::Body.parse [1, 2, 3]
  ...
  describe "#to_a" do
    it "returns the body data as an array" do
      body = Chippy::Message::Body.new([1, 2, 3])
  ...
  describe "#to_s" do
    it "returns a string representation of the body data" do
      body = Chippy::Message::Body.new([255, 255, 255])
  ...
  context "equality" do
    describe "==(other)" do
      it "is true when two bodies with same data" do
        data = [1, 2, 3]
        first_body = Chippy::Message::Body.parse(data, type: :REQUEST)
        second_body = Chippy::Message::Body.parse(data, type: :REQUEST)
      ...
      it "is false when comparing two different bodies" do
        ...
        first_header = Chippy::Message::Body.parse(first_data, type: :REQUEST)
        second_header = Chippy::Message::Body.parse(second_data, type: :REQUEST)
